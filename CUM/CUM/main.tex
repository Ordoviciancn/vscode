...
\bibitem{GB/T 42905-2023}
国家标准委
\newblock GB/T 42905-2023, 碳化硅外延片技术条件[S].
\newblock 2023.
\bibitem{SiC_Film_2019}
红外与激光工程编辑部.
\newblock 脉冲激光沉积法制备红外光学SiC薄膜特性研究[J].
\newblock 红外与激光工程, 2019, 48(7): 0742003.

\bibitem{TIAWBS0072018}
中关村天合宽禁带半导体技术创新联盟.
\newblock T/IAWBS007-2018, 4H碳化硅同质外延层厚度的红外反射测量方法[S].
\newblock 2018.

\bibitem{Fresnel_2000}
苏力, 蓝玉龙.
\newblock 菲涅尔公式的几何表示法再探[J].
\newblock 广西大学学报(自然科学版), 2000, 25(2).

\bibitem{Fresnel_Exp_2019}
吴咏桐, 丁永文.
\newblock 菲涅尔公式的实验研究[J].
\newblock 大学物理实验, 2019, 32(3): 46-49.

\bibitem{LambertBeer_2025}
计量学报编辑部.
\newblock 基于Lambert-Beer定律的吸光度监测微容量液体体积测量系统及方法研究[J].
\newblock 计量学报, 2025(2).

\bibitem{LambertBeer_Blood_2023}
马俊, 刘刚, 李超, 等.
\newblock 基于Lambert-Beer定律修正血氧饱和度R值曲线[J].
\newblock 计量科学与技术, 2023(1): 23-28.

\bibitem{PSO_2020}
工程热物理学报编辑部.
\newblock 细粒度指数惯性权重自适应粒子群算法及应用[J].
\newblock 工程热物理学报, 2020(9).

\bibitem{PSO_MultiStrategy_2022}
杨光永.
\newblock 多策略融合的改进粒子群优化算法[J].
\newblock 计算机应用研究, 2022, 39(11): 3358-3364.

\bibitem{SiC_Hetero_2009}
中国激光编辑部.
\newblock 化学气相淀积(CVD)方法生长4H-SiC薄膜的研究[J].
\newblock 中国激光, 2009, 36(5): 1209.

\bibitem{SiC_Optical_Properties}
Choyke W J, Pensl G.
\newblock Physical properties of SiC[J].
\newblock MRS Bulletin, 1997, 22(3): 25-29.

\bibitem{Infrared_Ellipsometry}
Fujiwara H, Kondo M, Matsuda A.
\newblock Structure and growth of hydrogenated silicon carbide films studied by in situ infrared spectroscopy and real-time ellipsometry[J].
\newblock Physical Review B, 2003, 67(15): 155306.

\bibitem{PSO_Review}
Poli R, Kennedy J, Blackwell T.
\newblock Particle swarm optimization: An overview[J].
\newblock Swarm Intelligence, 2007, 1(1): 33-57.

\bibitem{Thin_Film_Measurement}
Tompkins H G, McGahan W A.
\newblock Spectroscopic ellipsometry and reflectometry: a user's guide[M].
\newblock New York: John Wiley \& Sons, 1999.

\bibitem{SiC_Epitaxy}
Neudeck P G, Powell J A.
\newblock Performance limiting micropipe defects in silicon carbide wafers[J].
\newblock IEEE Electron Device Letters, 1994, 15(2): 63-65.

\bibitem{Interference_Theory}
Born M, Wolf E.
\newblock Principles of optics: electromagnetic theory of propagation, interference and diffraction of light[M].
\newblock 7th ed. Cambridge: Cambridge University Press, 1999.

\bibitem{Optical_Constants}
Palik E D.
\newblock Handbook of optical constants of solids[M].
\newblock Orlando: Academic Press, 1985.

\bibitem{PSO_Applications}
Particle Swarm Central.
\newblock Special issue on particle swarm optimization[J].
\newblock IEEE Transactions on Evolutionary Computation, 2004, 8(3): 201-228.

\bibitem{SiC_Characterization}
Matsunami H, Kimoto T.
\newblock Step-controlled epitaxial growth of SiC: High quality homoepitaxy[J].
\newblock Materials Science and Engineering: R: Reports, 1997, 20(3): 125-166.
\end{thebibliography}
